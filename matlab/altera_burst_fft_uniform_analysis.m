% -----------------------------------------------------------------------------
% altera_burst_fft_uniform_analysis.m
%
...
% Figure generation
if (use_altera)
	pdfbase = sprintf('altera_burst_uniform_%d_%d', Bx, Bw);
else
	pdfbase = sprintf('radix4_bfp_uniform_%d_%d', Bx, Bw);
end
pdfbase = '';
...
% -----------------------------------------------------------------------------
%
fft_analysis_uniform(fft_fixed, fft_double, Bx, N, M, pdfbase)

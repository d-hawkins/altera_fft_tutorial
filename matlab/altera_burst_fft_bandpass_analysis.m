% -----------------------------------------------------------------------------
% altera_burst_fft_bandpass_analysis.m
%
...
% Figure generation
if (use_altera)
	pdfbase = sprintf('altera_burst_bandpass_%d_%d', Bx, Bw);
else
	pdfbase = sprintf('radix4_bfp_bandpass_%d_%d', Bx, Bw);
end
pdfbase = '';
...
% -----------------------------------------------------------------------------
%
fft_analysis_bandpass(fft_fixed, fft_double, Bx, N, M, LF_dB, pdfbase)
